...
const WellnessDashboard = () => {
  ...
  const fetchDashboard = async () => {
    try {
      ...
      const response = await fetch('https://aaa95094eca4.ngrok-free.app/wellness/dashboard', {
        method: 'GET',
        headers: {
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="p-3 bg-forest-dark/50 rounded-xl">
                <Heart className="w-8 h-8 text-forest-light" />
              </div>
              <div>
                <h1 className="text-3xl font-bold text-white">Wellness Dashboard</h1>
                <p className="text-gray-300 mt-1">Employee health and wellness insights</p>
              </div>
            </div>
            <button
